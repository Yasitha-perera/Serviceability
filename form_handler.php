...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $equipment = $_POST["field3"]; // Assuming field3 is your equipment field
    $stid = isset($_SESSION['stid']) ? $_SESSION['stid'] : '';
    date_default_timezone_set('Asia/Colombo');
    // Assuming stid is stored in the session
