...
footer {
    ...
    background-color: rgb(255, 121, 4,0.5) ;
}
  </style>
</head>
<body>
  ...
  $sql = "SELECT * FROM machine WHERE stid = $loggedInUserStid AND cid = 4 AND machine_type = 'item'";
  ...
  if ($result->num_rows > 0) {
      while ($row = $result->fetch_assoc()) {
          ...
          echo "<input type='hidden' name='cid[]' value='4'>"; 
          echo "<input type='hidden' name='machine_type[]' value='item'>"; 
