...
<body>
    <div class="wrapper">
        <nav class="nav"><img src="images\Serviceability Report System_Logo.png" alt="Logo">
            <div class="nav-logo">
            ...
            <div class="nav-menu" id="navMenu">
                <ul> 
                        ...
                        <!-- Display this link only if the user is not an admin -->
                        <li><a href="Communication.php" class="link">Communication</a></li>
                        <!-- Display this link only if the user is not an admin -->
                        <li><a href="Navigation.php" class="link">Navigation</a></li>
                        <!-- Display this link only if the user is not an admin -->
                        <li><a href="Surveillance.php" class="link">Surveillance</a></li>
                        <!-- Display this link only if the user is not an admin -->
                        <li><a href="IT.php" class="link">IT</a></li>
