...
<form method='post' action='save_serviceability.php'> 
  ...
  $sql = "SELECT * FROM equipments WHERE stid = $loggedInUserStid AND cid = 3 AND loid='CACC'";
...
$sql = "SELECT * FROM machine WHERE stid = $loggedInUserStid AND cid = 3 AND machine_type = 'surveillance' AND loid='CACC'";
$result = $conn->query($sql);
...
$sql = "SELECT * FROM machine WHERE stid = $loggedInUserStid AND cid = 3 AND machine_type = 'surveillance supports'  AND loid='CACC'";
$result = $conn->query($sql);
