        ...
        <nav class="nav">
            ...
            <div class="nav-menu" id="navMenu">
                <ul> 
                        ...
                        <li><a href="home2.php" class="link">Home</a></li>
                        <!-- Display this link only if the user is not an admin -->
                        <li><a href="com.php" class="link">Communication</a></li>
                        <!-- Display this link only if the user is not an admin -->
                        <li><a href="nav.php" class="link">Navigation</a></li>
                        <!-- Display this link only if the user is not an admin -->
                        <li><a href="sur.php" class="link">Surveillance</a></li>
                        <!-- Display this link only if the user is not an admin -->
                        <li><a href="id.php" class="link">IT</a></li>
