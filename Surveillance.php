...
.container {
    ...
    .form {
        background-color: rgba(213, 35, 49, 0.5); /* Adjust the alpha value as needed */
    padding: 20px;
    border-radius: 5px;
    ...
    button[type="submit"] {
        background-color: rgba(213, 35, 49); 
        color: white;
        padding: 10px 20px;
        border: none;
        border-radius: 4px;
    ...
    button[type="submit"]:hover {
        background-color:rgba(213, 35, 49, 0.7); 
    }
    input[type="text"],
    select {
...
?>
    ...
    <label for="field3">Item-   Station:</label>
        ...
        <div class="form-container">
            <h2>Surveillance Supports</h2>
            <form class="form" action="form_handler1.php" method="POST">
            <label for="status">Location:</label>
        <select name="location" id="location">
        <option value="-Select-" selected disabled>-Select-</option>
...
?>
    ...
    <div class="form-container">
            <h2>Equipments</h2>
            <form class="form" action="form_handler2.php" method="POST">
            <label for="status">Location:</label>
        <select name="location" id="location">
        <option value="-Select-" selected disabled>-Select-</option>
...
?>
                ...
                <label for="field2">Naming in SOP:</label>
                <input type="text" id="field2" name="field2"><br><br>
                <label for="field2">Naming in EANE:</label>
                <input type="text" id="field3" name="field3"><br><br>
                <label for="field2">Item:</label>
