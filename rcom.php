...
<form method='post' action='save_serviceability.php'> 
  ...
  $sql = "SELECT * FROM vhf_communication WHERE stid = $loggedInUserStid AND cid = 1 AND loid='CACC'";
...
$sql = "SELECT * FROM machine WHERE stid = $loggedInUserStid AND cid = 1 AND machine_type = 'scanners' AND loid='CACC'";
$result = $conn->query($sql);
...
$sql = "SELECT * FROM machine WHERE stid = $loggedInUserStid AND cid = 1 AND machine_type = 'links' AND loid='CACC'";
$result = $conn->query($sql);
