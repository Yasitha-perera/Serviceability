...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<input type='hidden' name='cid[]' value='2'>"; 
        echo "<input type='hidden' name='machine_type[]' value='None'>"; 
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<input type='hidden' name='loid[]' value='" . $row['loid'] . "'>";
        echo "<input type='hidden' name='cid[]' value='2'>"; 
        echo "<input type='hidden' name='machine_type[]' value='rwy04'>"; 
        echo "<input type='hidden' name='stid[]' value='" . $loggedInUserStid . "'>"; // Add stid as hidden input
        echo "<select name='serviceability[]' class='form-control'>";
        echo "<option value='0' selected>Select</option>"; 
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<input type='hidden' name='loid[]' value='" . $row['loid'] . "'>";
        echo "<input type='hidden' name='cid[]' value='2'>"; 
        echo "<input type='hidden' name='machine_type[]' value='rwy22'>"; 
        echo "<input type='hidden' name='stid[]' value='" . $loggedInUserStid . "'>"; // Add stid as hidden input
        echo "<select name='serviceability[]' class='form-control'>";
        echo "<option value='0' selected>Select</option>"; 
